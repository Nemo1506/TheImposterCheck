...
def list_sample_files():
    ...
    descriptions = {
        ...
        "11_match_nemaan_selfie.png": {"title": "Matching Face Selfie (Photo)", "category": "Comparison Set", "expected": "MATCH", "desc": "Selfie matching Nemaan ID (use in Multi-File Compare)."},
