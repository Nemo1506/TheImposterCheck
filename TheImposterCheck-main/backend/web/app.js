...
function openSocialAuthModal(provider) {
  ...
  if (p === "google") {
    ...
    elements.socialAuthEmail.value = "nemaan@gmail.com";
  } else if (p === "github") {
    elements.socialModalIcon.innerHTML = `
    ...
    elements.socialAuthEmail.value = "Nemo1506";
  } else if (p === "apple") {
    elements.socialModalIcon.innerHTML = `
      <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
    ...
    elements.socialAuthEmail.value = "nemaan@icloud.com";
  } else if (p === "microsoft") {
    elements.socialModalIcon.innerHTML = `
      <svg viewBox="0 0 24 24" width="24" height="24">
    ...
    elements.socialAuthEmail.value = "nemaan@outlook.com";
  }

  elements.socialAuthName.value = "Nemaan";
...
async function handleSocialPopupSubmit(e) {
  e.preventDefault();
  const name = elements.socialAuthName.value.trim() || "Nemaan";
...
function openProfileModal() {
  const user = state.user || {
    ...
    avatar: "https://api.dicebear.com/7.x/bottts/svg?seed=Nemaan",
