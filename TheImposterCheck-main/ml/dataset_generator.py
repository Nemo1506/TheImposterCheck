...
NAMES = [
    "NEMAAN THUNDIYIL", "JOHNATHAN DOE", "SARAH CONNER", "DAVID KIM", "ELENA ROSTOVA",
...
def generate_base_id(name="NEMAAN THUNDIYIL", doc_id="DL-8892140A", title="STATE DRIVER LICENSE", seed=1):
    w, h = 600, 380
